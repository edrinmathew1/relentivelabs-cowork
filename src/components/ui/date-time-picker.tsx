...
export function DateTimePicker({ value, onChange, label }: DateTimePickerProps) {
  ...
  return (
    <div className="space-y-1 relative">
      ...
      {/* Wheel & Visual Picker Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 z-50 mt-1 w-80 bg-[#141414] border border-[#262626] rounded-xl p-4 shadow-2xl space-y-4 text-xs">
          {/* Month Header */}
          ...
          <div className="pt-3 border-t border-[#262626] space-y-2">
            <div className="flex items-center justify-between text-[11px] font-semibold text-[#A3A3A3]">
              <span className="flex items-center gap-1">
                <Clock className="w-3 h-3 text-[#E10600]" /> Select Time Wheel
              </span>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <div className="max-h-24 overflow-y-auto space-y-1 bg-[#0A0A0A] border border-[#262626] rounded-lg p-1">
          ...
          <button
            ...
            className="w-full py-1.5 bg-[#E10600] hover:bg-[#FF3B3B] text-white text-xs font-bold rounded-lg transition"
          >
            Confirm Date & Time
          </button>
        </div>
